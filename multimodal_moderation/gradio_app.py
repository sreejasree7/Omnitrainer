...
class ChatSessionWithTracing:
    ...
    def __init__(self):
        ...
        self.conversation_span = tracer.start_span("conversation",attributes={"session.id": self.session_id}) # Replace with your span
                ...
                # MODERATION STEP 2: Check media files
                    ...
                    for file_path in value:
                        ...
                        try:
                            ...
                            file_input = BinaryContent(data=file_bytes, media_type=mime_type)
